			...
			<section>
				<div className="bannerbg">
					<div className="container">
						<div className="tradelogo"><Image src={`https://radonllcapi.mobel.us/public/uploads/tradeshow/${tradeshow.event_logo}`} alt={`${tradeshow.alt_tag}`} width="225" height="225" /></div>
