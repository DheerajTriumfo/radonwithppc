		   				...
		   				<div className="col-md-6 col-12">
		   					<div className="columninners">
				   				...
				   				<div className="shrtdesc">
				   					<p>Need a hassle-free booth rental for your next trade show? At Radon Exhibition, we offer customizable, ready-to-install exhibit booth rentals across major US cities. Whether it's a 10x20 or a double-decker, we manage everything from booth design to on-site setup.</p>
